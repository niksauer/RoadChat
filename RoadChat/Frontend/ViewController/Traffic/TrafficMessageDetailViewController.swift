//
//  TrafficMessageDetailViewController.swift
//  RoadChat
//
//  Created by Phillip Rust on 13.04.18.
...
class TrafficMessageDetailViewController: UIViewController {
    ...
    private let message: TrafficMessage
    ...
    // MARK: - Initialization
    init(viewFactory: ViewControllerFactory, message: TrafficMessage, sender: User, activeUser: User, dateFormatter: DateFormatter, colorPalette: ColorPalette) {
    ...
    @IBAction func didPressProfileButton(_ sender: UIButton) {
        let profileViewController = viewFactory.makeProfileViewController(for: self.sender, activeUser: activeUser, showsPublicProfile: true)
